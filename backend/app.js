...
// Enables better overall security with the helmet middleware
// Helmet helps set a variety of headers to better secure your app
app.use(helmet({
    // Disable the Content Security Policy feature in helmet
    contentSecurityPolicy: false
}));

// Set the _csrf token and create req.csrfToken method
// provides CSRF (Cross-Site Request Forgery) protection for your application
app.use(
    csurf({
        cookie: {
            secure: isProduction,
